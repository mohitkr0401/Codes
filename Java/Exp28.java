...
class DBConnectivity {
    ...
    void makeConnection() {
        try {
            ...
            CO = DriverManager.getConnection("jdbc:mysql://localhost:3306/java", "root", "Mohit@0401");
        } catch (Exception Ee) {
    ...
    void displayFirst() {
        try {
            ...
            RS.first();
            System.out.println(RS.getInt("H_NO") + RS.getString("H_LOCALITY") +
                    RS.getInt("H_ROOMS") + RS.getString("H_OWNER"));
            RS.close();
            SMT.close();
        } catch (Exception Ee) {
            System.out.println(Ee);
